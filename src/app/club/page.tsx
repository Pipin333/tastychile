              ...
              <ul className="space-y-4 mb-8">
                <li className="flex items-start">
                  <span className="text-green-500 mr-3 text-xl">✓</span>
                    <p className="text-gray-700 font-medium"><strong>1 Bolsa Full (250g)</strong> de tu variedad preferida (Marsellesa, Caturra, Catimore, Pink Bourbon, Tupi o Geisha).</p>
                </li>
                <li className="flex items-start">
                  <span className="text-green-500 mr-3 text-xl">✓</span>
